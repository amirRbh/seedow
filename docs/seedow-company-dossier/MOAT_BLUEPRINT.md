...
2. **L'Autorité** — cette donnée rendue **publique et citable** (observatoire greenwashing, pages fonds sourcées, droit de réponse). Un acteur qui *vend des produits* ne peut pas être le tiers neutre. Terrain que les incumbents ne peuvent pas occuper crédiblement.
...
- **Fin Phase A** : ≥ 3 connecteurs actifs, dashboard data-health visible, provenance de bout en bout. → *tu valides avant Phase B.*
