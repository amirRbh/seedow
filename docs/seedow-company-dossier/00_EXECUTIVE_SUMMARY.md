...
> Dossier stratégique Seedow — basé sur l'état réel du repo `amirRbh/seedow` (commit `b7203c8`, 2026-08-14) + sources externes datées. Convention : **FACT / HYPOTHÈSE / ESTIMATION / OBJECTIF / UNKNOWN**. Aucune donnée de traction n'a été inventée.
...
**La bonne nouvelle** : le marché est réel et porteur (AMF : +83 % d'investisseurs ETF en France en 2025 ; Europe = 84 % des actifs durables mondiaux — Morningstar), et Seedow gagne déjà sur **conviction + transparence + pédagogie + impact**. Il perd sur **exécution + confiance/marque + distribution**.

**Ce qui doit changer, dans l'ordre** : (1) mesurer la vérité, (2) débloquer l'acte d'investir (passerelle courtier), (3) prouver l'activation/rétention, (4) tester le prix — puis (5) industrialiser la data comme moat + revenu B2B. **Prouver > Construire.**
...
- **Combien** : **pré-seed ~150-400 k€** pour 9-12 mois de preuves (pas un gros seed sur promesse), gros tour ensuite sur données (`14`).
- **Preuves à obtenir** : activation ≥ 40-50 %, D30 ≥ 25 %, intention→acte, willingness-to-pay, CAC organique (`15`).
...
4. **Découpler la classification durable de SFDR** (anti-obsolescence).
