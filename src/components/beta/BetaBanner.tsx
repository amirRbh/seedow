...
export function BetaBanner() {
  ...
  return (
    <div className="bg-paper-2 border-b border-paper-3 px-5 py-2">
      <div className="max-w-lg mx-auto flex items-center gap-2 text-tag uppercase tracking-[0.18em] text-ink-3">
        ...
        <span className="text-ink-3 normal-case tracking-normal text-caption">
