  ...
  public: {
    ...
    Functions: {
      ...
      get_latest_asset_prices: {
        ...
        Returns: { asset_id: string; close: number; price_date: string }[];
      };
    ...
    Enums: {
      ...
      asset_class:
        ...
        | "cash"
        | "corporate_bond";
      cause_tag: "climat" | "biodiversite" | "humain" | "egalite" | "tech" | "circulaire";
      ...
      decision_kind:
        ...
        | "contribution_paused";
      exclusion_tag: "fossiles" | "armes" | "tabac" | "jeux" | "animaux" | "fast-fashion";
      goal_type: "retirement" | "real_estate" | "studies" | "safety_net" | "other";
    };
    CompositeTypes: {
      [_ in never]: never;
    };
