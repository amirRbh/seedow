...
export const course: Course = {
  ...
  intro:
    "Aligner son portefeuille avec ses valeurs ne signifie pas tout sacrifier à la performance, ni à l'inverse acheter n'importe quel produit étiqueté « green ». C'est un travail explicite, structuré, qui prend une journée par an. Voici la méthode.",
  sections: [
    {
      heading: "Étape 1 : définir ses lignes rouges",
      paragraphs: [
        "Avant de chercher des produits, formaliser noir sur blanc ce qu'on refuse de financer. Liste typique : énergies fossiles, armement, tabac, jeux d'argent, paradis fiscaux. Liste à étendre selon ses convictions.",
    ...
    },
    {
      ...
      paragraphs: [
        "Exclusion stricte : on retire tout ce qui dépasse les seuils. Approche simple, lisible, mais réduit l'univers et peut concentrer le portefeuille.",
        "Best-in-class : dans chaque secteur, on garde les meilleurs sur les critères ESG. Maintient la diversification, mais conserve par construction des secteurs problématiques (énergies fossiles, par exemple).",
        "Impact / thématique : on cible des activités explicitement positives (énergies renouvelables, eau, santé, économie circulaire). Forte cohérence, faible diversification, volatilité supérieure.",
        "Engagement actionnarial : on garde les entreprises problématiques mais on vote activement pour les faire évoluer. Demande des fonds qui font vraiment ce travail (rare en pratique chez les particuliers).",
      ],
    },
    {
      ...
      paragraphs: [
        ...
        "Décliner la poche actions : un ETF mondial ESG comme socle (40 à 60 %), un ETF émergents ESG (10 à 15 %), une ou deux briques thématiques d'impact (énergies renouvelables, eau, santé, 10 à 20 %).",
    ...
    },
    {
      ...
      paragraphs: [
        "PEA : très adapté pour la poche actions européennes ESG (ETF MSCI Europe ESG par exemple). Fiscalité avantageuse après 5 ans.",
        ...
        "PER (Plan Épargne Retraite) : intéressant si TMI élevée, gamme ESG souvent disponible.",
      ],
    },
    {
      ...
      paragraphs: [
        ...
        "Trois critères de rejet : présence d'entreprises clairement contradictoires avec les lignes rouges dans le top 10 ; intensité carbone non communiquée ; frais supérieurs à 1,5 % sans justification de gestion active.",
        "Croiser au minimum deux sources d'information : fiche du gérant + plateforme indépendante (Morningstar, Quantalys, Novethic).",
      ],
    },
    {
