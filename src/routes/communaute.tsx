      ...
      <div className="mx-auto max-w-6xl px-4 md:px-8">
        ...
        >
          {myESG != null && median != null && (
            <div className="mb-8 rounded-lg border border-paper-3 bg-paper-2 p-5">
              <p className="text-[10px] uppercase tracking-[0.22em] text-gold mb-2">Où vous vous situez</p>
